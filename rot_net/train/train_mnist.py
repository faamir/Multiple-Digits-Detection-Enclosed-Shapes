...
kernel_size = (3, 3)
# number of classes for now only 45 degree. max 360 degree (45 in scripts should be 360 then)
nb_classes = 45
...
# model compilation
model.compile(
    loss="categorical_crossentropy", optimizer="adam", metrics=[angle_error]
)
...
output_folder = "./rot_net/saved_models"
...
model.fit_generator(
    ...
    validation_data=RotNetDataGenerator(
        X_test, batch_size=batch_size, preprocess_func=binarize_images
    ),
...
# model.save("./rot_net/saved_models/rotation_finder.h5")
